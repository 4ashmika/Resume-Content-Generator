                ...
                {activeTab === 'preview' && (
                  <div className="flex items-center space-x-2">
                    <button
                        ...
                        className="px-4 py-2 text-sm font-medium rounded-md transition-colors flex items-center gap-2 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
                        title="Export CV"
                    >
                        {isExporting ? (
                            <>
